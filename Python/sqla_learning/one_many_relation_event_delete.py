...
# use events to delete all associated books
@event.listens_for(session, 'before_flush')
def delete_books(session, flush_context, instances):
    # session._deleted is a dictionary
    # http://docs.sqlalchemy.org/en/rel_0_9/orm/session_state_management.html#session-attributes
...
print
print 'Remove members with first name Jane'
print
# Remove a record
